...
public class Exercicio06 {
	...
	public static void main(String[] args) {
		...
		// criar um menu para o usuário escolher a opção 
		int opcao = 1;
	...
	private static void limparVetor(Lista<Contato> lista) {
		...
		System.out.println("Todos os contatos d vetor foram excluídos");
	}
	...
	private static void pesquisarUltimoIndice(Scanner scan, Lista<Contato> lista) {
		...
		try {
			...
			System.out.println("Fazndo pesquisa do último índice do contato encontrado: ");
	...
	private static void adicionarContatoPosicao(Scanner scan, Lista<Contato> lista) {
		...
		int pos = leInformacaoInt("ENtre com a posição a adicinar o contato", scan);
